If you are only generating a policy checklist refer to the [Policy Checklist Data](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#policy-checklist-data)      
...
|--------------|--------------------|----------------|
|Required      | [OpenStreetMap](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#openstreetmap-data)      | an OpenStreetMap .pbf file with coverage of the region (and time) of interest; this could be an [historical planet file](https://planet.openstreetmap.org/pbf/), or a [region-specific excerpt](https://download.geofabrik.de/) |
|Required      | [population_grids](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#population-grid-data)   | Population distribution raster grid or vector data with coverage of urban region of interest. [GHS population grid (R2023)](https://ghsl.jrc.ec.europa.eu/download.php?ds=pop) is recommended (for example, the 2020 Molleweide 100m grid tiles corresponding to your area of interest, with these saved and extracted to a folder like  `process/data/GHS/R2023A/GHS_POP_E2020_GLOBE_R2023A_54009_100_V1_0`, which may be specified in `process/configuration/datasets.yml`.  *Take care to select the correct Epoch for your analysis before downloading!* |
|Conditional   | [region_boundaries](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#region-boundary-data)  | Vector boundary for identifying study region (e.g. geopackage, geojson or shp).  If a geopackage is used, a specific layer can optionally be specified and queried, as per [this example](https://github.com/healthysustainablecities/global-indicators/blob/d89122996a6a10be512d16d01b8f1a0398ce04a3/process/configuration/regions/additional%20example%20regions/BE_Ghent_2022.yml#L12) |
|Conditional   | [urban_regions](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#urban-region-data)      | [Global Human Settlements Layer](https://ghsl.jrc.ec.europa.eu/download.php) Urban Centres database and/or administrative boundary for urban region of interest |
|Optional      | [policy_review](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#policy-checklist-data)      | Summarising results of a policy review analysis |
|Optional      | [transit_feeds](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#gtfs-transit-feed-data)      | Collections of zipped GTFS feeds to represent public transport service frequency |
|Optional      | [other_custom_data](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data-(OR-Configuring-Input-Data-for-New-Study-Regions%3F)#data-output-folder)  | Other custom data, such as points of interest |
...
[&larr;](https://github.com/healthysustainablecities/global-indicators/wiki/5.-Detailed-Setup) [&uarr;]() [&rarr;](https://github.com/healthysustainablecities/global-indicators/wiki/7.-Advanced-Features)