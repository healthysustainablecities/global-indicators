...
Once the policy checklist has been completed, the [results can be summarised, queried and generated into a PDF report](https://github.com/healthysustainablecities/global-indicators/wiki/5.-Detailed-Setup#policy-checklist-data) using the GHSCI web app (Figures 12 and 13).
...
[&larr;](https://github.com/healthysustainablecities/global-indicators/wiki/6.-Data) [&uarr;]() [&rarr;](https://github.com/healthysustainablecities/global-indicators/wiki/8.-Useful-Links-and-Resources)
