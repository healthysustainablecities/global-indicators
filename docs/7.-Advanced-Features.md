...
- **[Custom data](https://healthysustainablecities.github.io/global-indicators/Custom-data)** — supply your own destinations (`points_of_interest`), public open space (`public_open_space`), and sample point locations (`sampling`), to supplement or replace what is derived from OpenStreetMap.
