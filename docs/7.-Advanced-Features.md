...
Once the policy checklist has been completed, the [results can be summarised, queried and generated into a PDF report](https://healthysustainablecities.github.io/global-indicators/5.-Detailed-Setup#policy-checklist-data) using the GHSCI web app (Figures 12 and 13).
